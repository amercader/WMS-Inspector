...
INSERT INTO services (title,url,version,favorite,type,creation_date) VALUES
("JPL Global Imagery Service","http://wms.jpl.nasa.gov/wms.cgi","1.1.1",0,"WMS",strftime('%s','now'));

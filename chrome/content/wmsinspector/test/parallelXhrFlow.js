 ...
 */
var PAGESPEED2 = {}
PAGESPEED2.ParallelXhrFlow = function(opt_onAllComplete) {
  /** @type {Array.<PAGESPEED2.XhrRequest>} */ this.requests_ = [];
 ...
 */
PAGESPEED2.ParallelXhrFlow.prototype.addRequest = function(type,
                                                          url,
                                                          params,
                                                          data,
                                                          opt_onComplete,
  ...
  var self = this;
  var request = new PAGESPEED2.XhrRequest(type, url, params, data,
 ...
 */
PAGESPEED2.ParallelXhrFlow.prototype.clearRequests = function() {
  this.requests_ = [];
 ...
 */
PAGESPEED2.ParallelXhrFlow.prototype.sendRequests = function() {
 ...
 */
PAGESPEED2.ParallelXhrFlow.prototype.getNumOutstandingRequests = function() {
 ...
 * @return {number} The number of outstanding requests.
 */
PAGESPEED2.ParallelXhrFlow.prototype.getTotalRequests = function() {
 ...
 * @private
 */
PAGESPEED2.ParallelXhrFlow.prototype.onComplete_ = function(callback,
                                                           callback_arg) {
 ...
 * @constructor
 */
PAGESPEED2.XhrRequest = function(type, url, params, data, onComplete, onError) {
  this.type = type;
  this.url = url;
  this.params = params;
  this.data = data;
 ...
 */
PAGESPEED2.XhrRequest.prototype.send = function() {
  var self = this;
